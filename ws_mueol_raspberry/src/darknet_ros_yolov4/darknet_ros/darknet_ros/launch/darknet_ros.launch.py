...
def generate_launch_description():
  ...
  image = LaunchConfiguration('image', default = 'camera_right')
  ...
  network_param_file = LaunchConfiguration('network_param_file', default = darknet_ros_share_dir + 'config/yolov4-tiny-custom.yaml')
